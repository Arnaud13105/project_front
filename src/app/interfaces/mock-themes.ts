...
export const THEME1: Theme[] = [
    ...
    {id :2, nomformation : 'C#',  domaine : 'informatique',    theme : 'informatique',    description: 'en presidentielle',     prix : '250',   duree : '3', prerequis : 'Des connaissances en C# (telles que les notions de classes, objets, héritage'},
...
export const THEME2: Theme[] = [
    ...
    {id :2, nomformation : 'PHP',  domaine : 'Informatique',    theme : 'theme2',    description: 'en presidentielle',     prix : '150',   duree : '3', prerequis : 'connaissance en php'},
    {id :3, nomformation : 'Angular',  domaine : 'Informatique',    theme : 'theme2',    description: 'en presidentielle',     prix : '180',   duree : '3', prerequis : 'connaissance en angular'},
];